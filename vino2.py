...
cl = LINETCR.LINE()
cl.login(token="Emnd8AmBxdBVPMqQLLG1.2D74drthPpP9dUF4gn/ZSq.fl4qRTZfwAhPGWcjLsZCKwZnPbc6xrd2jLBSghKNSI8=")
cl.loginResult()

ki = LINETCR.LINE()
ki.login(token="Emxe3kzGX5J2sylu6G59.V7H1cSgdLPGIwT7GviPykq.As0nNqn3Zc0YtZimMXjfOvI7ufZ5aeNrgFZDr51sbHM=")
ki.loginResult()

kk = LINETCR.LINE()
kk.login(token="Em0BwltaBIyVC6ByVUd0.yavE8KA9LDa8ryLnAP7kaa.iDu8ep+hVYpUubZPfPLIB+O2Jdar2nYn7k94RgsfLk4=")
kk.loginResult()

kc = LINETCR.LINE()
kc.login(token="Em0W8GXmlpJfBkL0DMkf.A41RdxWYqdJx2WkzMUhQ7W.54T1cURPsRz9btoAUKs5DdFiDXBYJ2Q3pq8VBjSf/jY=")
kc.loginResult()

kd = LINETCR.LINE()
kd.login(token="EmAqbOxxqjKWDRVQo7Na.E/yoR/Nty5QrrTla8kLioG.7ZGZZHoJLE8gARR8lcEHEPyH2k/DekNX2ArflAYx+nA=")
kd.loginResult()

ke = LINETCR.LINE()
ke.login(token="Em9pnlvTzjJnMIeu94Q0.0nYjTgR1MV4Rhnndf+P7qa.iCmxllLEuC10I/cbrPleYsO9hB86Iyrisg0VclZiAYw=")
ke.loginResult()

kf = LINETCR.LINE()
kf.login(token="EmrYSjnBDGhjixeI9HRb.ebttn82KxqOHqQNJI67PwW.gpGQCfAfaB7nI9/AhG6MYpeWHYPTBKsDAcHx7eRuB9w=")
kf.loginResult()

kg = LINETCR.LINE()
kg.login(token="EmnM2Wem1CtFAo5UoIY5.9Y3lTMbLVDJyENqd8VtU9q.PxG6iL5xgk2odm2H2vsbUkWDg3EAFiP/JCjV3TI5rOA=")
kg.loginResult()

kh = LINETCR.LINE()
kh.login(token="Eml1nw7KGccqQwvA0rKe.KnZDNleZk2SKMIjI6TPRhG.eArTFLFqxEdz3ImqH0ulPIauZRvpVnlelUu20VcgHQ8=")
kh.loginResult()

kj = LINETCR.LINE()
kj.login(token="Em5VvwsRFlfwisEscU59.xVEA65IJOJwcnoZTiMASwq.O2zHbL401wkvxsGUT5S7pTUe0q9s/ghdRV1c08pRBXY=")
kj.loginResult()

kl = LINETCR.LINE()
kl.login(token="EmmG5qApifQt8tMeGLu7.s7xwJr48yiWcD8WLRnglrW.e2t6QWAR0Ev9mnGkXRVAuLyoXqj2Zt5+mwsOaqAY77k=")
kl.loginResult()

km = LINETCR.LINE()
km.login(token="Em2GlYN3x5FY0gvu2dF3.qtTQsxIlgy7YFLdqrM30eW.Nr28ZAmskPhZfh/KPfljuJ0730Z1hRsr1B722CbyrW4=")
km.loginResult()
...
owner=["ub736c5b1794f5aa30026d162d07ce5e6"]
wait = {
    'contact':False,
    'autoJoin':False,
    ...
    "lang":"JP",
    "comment":"Thanks for add me fans",
    "commentOn":True,
    "commentBlack":{},
    "wblack":False,
    "dblack":False,
     ...
     for zx in range(0,20):
        ...
        if hasil['result']['posts'][zx]['postInfo']['liked'] == False:
          try:
            ...
            cl.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"AutoLike by : TAMII 々•┅─────")
